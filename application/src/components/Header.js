      ...
      <AppBar position="static" style={{ background: '#d57276' }} >
        <Toolbar style={{ minHeight: 40, background: '#d57276', margin: "auto",
          ...
          <Typography style={{ display: "flex", flexDirection: 'row', justifyContent: 'center', padding: 0, width: 'none' }} variant="h6" component="ul">
              ...
              <ListItem style={{ width: "100%", display: 'flex', justifyContent: 'center'}} button component={Link} to="/login">Login</ListItem>
              <ListItem style={{ width: "100%", display: 'flex', justifyContent: 'center'}} button component={Link} to="/signup">Reg</ListItem>
          </Typography>
          </Box>
